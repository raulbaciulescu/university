...
public class ServiceManager {
    ...
    private ServiceManager(){
        elems=  findAllGrades();
        studenti= findAllStudents();
        teme = findAllHomeWorks();
    }

    private List<Nota> elems;
    ...
    public void addNota(Student student, Tema tema, double value, LocalDate date, String profesor) {
        Nota nota=new Nota(student,tema,value,date,profesor);
        elems.add(nota);
    }
