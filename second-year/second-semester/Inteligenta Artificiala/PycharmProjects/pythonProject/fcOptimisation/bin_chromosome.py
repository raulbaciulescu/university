...
from fcOptimisation.utils import binToInt
...
class Chromosome:
    ...
    def repres(self):
        ...
        for gene in self.__repres:
            ...
            realValue = self.__problParam['min'] + intValue / maxint * (
                        self.__problParam['max'] - self.__problParam['min'])
    ...
    def __eq__(self, c):
        return self.__repres == c.__repres and self.__fitness == c