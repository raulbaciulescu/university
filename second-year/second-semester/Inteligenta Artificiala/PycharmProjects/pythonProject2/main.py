...
# getting data
# ---------------------------------
input, output = readData("data/v1_world-happiness-report-2017.csv", ["Economy..GDP.per.Capita.", "Freedom"], "Happiness.Score")
...
#print('the learnt model: f(x) = ', str(w0), ' + ', str(w1), ' * x ' + str(w2))
