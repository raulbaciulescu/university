...
# # Testing dataset is used for validating of the model. All data from testing
# # dataset will be new to model and we may check how accurate are model predictions.
#
# np.random.seed(5)
# indexes = [i for i in range(len(inputs))]
# trainSample = np.random.choice(indexes, int(0.8 * len(inputs)), replace=False)
# validationSample = [i for i in indexes if not i in trainSample]
# print('train sample: ', trainSample)
...
# from my_regression import MyLinearUnivariateRegression
#
# # model initialisation
