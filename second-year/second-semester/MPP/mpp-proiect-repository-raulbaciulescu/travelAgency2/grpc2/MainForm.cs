...
namespace client
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void UpdateFlight(object? sender, FlightEventArgs e)
        {
            ...
            List<FlightModel> flightsNew = new List<FlightModel>();
        ...
        {
            Console.Write("main form load start!");
            ...
            List<Flight> flights = await controller.GetFlights();
            ...
            Console.Write("main form load final!");
        }
