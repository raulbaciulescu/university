...
import impl.ProposedWordRepositoryImpl;
...
public class StartServer {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        PlayerRepository userRepository = new PlayerRepositoryImpl();
        ProposedWordRepository proposedWordRepository = new ProposedWordRepositoryImpl();
        GameRepository gameRepository = new GameRepositoryImpl();
        ProposalRepository proposalRepository = new ProposalRepositoryImpl();

        Service service = new ServiceImpl(userRepository, proposedWordRepository, gameRepository, proposalRepository);
