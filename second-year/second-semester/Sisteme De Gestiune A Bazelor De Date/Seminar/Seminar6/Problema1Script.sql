...
--Creați un scenariu care reproduce problema de concurență dirty reads, 
--prin proceduri stocate sau interogări de sine stătătoare. 
--Găsiți o soluție pentru a remedia / evita această problemă. (2 puncte)
...
--in celalalt file? 
BEGIN TRANSACTION
	UPDATE Briose SET pret = 10 WHERE cod_briosa = 1;
ROLLBACK TRANSACTION


--Creați un index și scrieți o interogare a cărei execuție să utilizeze indexul. 
--Arătați că indexul este folosit afișând și explicând planul de execuție pentru interogare. (3 puncte)
CREATE INDEX index_Briose_descriere on Briose(descriere ASC)
---- Fara cluster o sa faca o sortare 🗿 in memorie
SELECT descriere FROM Briose ORDER BY descriere
