...
public class PolynomialGenerator {
    ...
    public static void generatePolynomials() {
        int numberOfPolynomials = Constants.numberOfPolynomials;
        int maxDegree = Constants.maxDegree;
        int maxMono = Constants.maxMono;
        try {
    ...
    private static void generatePoly(Integer numberOfPolynomials, Integer maxDegree, Integer maxMono) throws IOException {
        for (int i = 1; i <= numberOfPolynomials; i++) {
            ...
            generate(i, maxDegree, maxMono);
        }
    }

    private static void generate(Integer polynomialContor, Integer maxDegree, Integer maxMono) throws IOException {
